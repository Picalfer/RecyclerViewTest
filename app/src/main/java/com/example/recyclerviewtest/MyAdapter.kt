...
class MyAdapter(private val indexes: List<String>,private val names: List<String>, private val name2: List<String>):
    RecyclerView.Adapter<MyAdapter.MyViewHolder>() {


    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) { // special class for optimize data
    ...
    override fun onCreateViewHolder(
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.list_item_for_recycler_view,parent,false)
        return MyViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: MyViewHolder, position: Int) { // here we bind text labels with data
